                ...
                <Row>
                    <InputGroup className="mb-3">
                        ...
                        <Form.Control
                            ...
                            onChange={(e) =>
                                setPerson({ ...person, birthMonth: e.target.value })
                            }
                        />
                ...
                <Row>
                    <InputGroup className="mb-3">
                        ...
                        <Form.Select
                            ...
                            onChange={(e) =>
                                setPerson({ ...person, birthState: e.target.value })
                            }
                        >
                            {states.map((state) => (
                        ...
                        <Form.Select
                            ...
                            onChange={(e) =>
                                setPerson({ ...person, birthCounty: e.target.value })
                            }
                        >
                        ...
                        <Form.Control
                            ...
                            onChange={(e) =>
                                setPerson({ ...person, birthTown: e.target.value })
                            }
                        />
                    </InputGroup>
                </Row>
